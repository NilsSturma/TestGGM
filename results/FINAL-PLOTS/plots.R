...
# name = paste("results/", date, "sizes_star-tree_setup-1_n=1000_m=20.pdf", sep="")
# 
# # Load data
...
name = paste("results/FINAL-PLOTS/", date, "_sizes_star-tree_setup-2_n=1000_m=20.pdf", sep="")
...
s2_U_stat= readRDS("results/star_tree/U-stat/sizes/2n/2020-11-24-09-52_star-tree_setup=2_n=1000_m=20.rds")  # remove 2n!!!
...
# create pdf file
name = paste("results/FINAL-PLOTS/", date, "_vary-B_1.pdf", sep="")
if (save){
  pdf(name, width=8,height=6) 
}
...
name = paste("results/FINAL-PLOTS/", date, "_vary-B_2.pdf", sep="")

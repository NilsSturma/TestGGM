...
for (B in B_range){
  ...
  if (save){
    ...
    name_pdf = paste("./results/", tree, "/", test_strategy, "/vary-B-symmetric/", name, ".pdf", sep="")
    name_rds = paste("./results/", tree, "/", test_strategy, "/vary-B-symmetric/", name, ".rds", sep="")

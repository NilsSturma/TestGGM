...
name = paste("results/star-tree-general/", date, "_star-tree_setup-1_n=1000_m=20.pdf", sep="")

# Load data
s1_grouping = readRDS("results/star-tree-general/grouping/2020-11-21-13-17_star-tree_setup=1_n=1000_m=20.rds")
s1_run_over = readRDS("results/star-tree-general/run-over/2020-11-21-12-29_star-tree_setup=1_n=1000_m=20.rds")
s1_symmetric = readRDS("results/star-tree-general/symmetric/2020-11-21-11-56_star-tree_setup=1_n=1000_m=20.rds")
